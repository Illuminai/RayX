    ...
    public static class DemoScene extends Scene {
        ...
        private void exhibition() {
            ...
            add(new SubtractionSDF(
                    ...
                    new Sphere(new Vector3d(.03, 0, 0), (float) (.015 * (Math.sin(1) + 1.1))),
                    new BoxSDF(new Vector3d(0, 0, 0), new Vector3d(0, 0, 0), new Vector3d(.03, .03, .03))));

            add(new Sphere(new Vector3d(-.04, 0, 0), .03f, Material.refractionMaterial(new Vector3d(1,1,1),1, (float) (Math.sin(10) * 0.5 + 0.6))));
